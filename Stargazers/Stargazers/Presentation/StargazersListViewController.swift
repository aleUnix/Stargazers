...
class StargazersListViewController: UIViewController {
    ...
    private func setupNavigation() {
        navigationController?.navigationBar.largeTitleTextAttributes = [.foregroundColor : AppTheme.sysYellow ?? UIColor.black]
        navigationController?.navigationBar.titleTextAttributes = [.foregroundColor : AppTheme.sysYellow ?? UIColor.black]
        navigationController?.navigationBar.tintColor = AppTheme.sysYellow
    }
